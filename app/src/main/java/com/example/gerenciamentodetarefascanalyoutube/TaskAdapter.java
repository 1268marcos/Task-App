...
//    public boolean setStateCheckBox(int isFinished){
//        if(isFinished == 1){
//            return true;
//        } else {
//            return false;
...
//    }
    ...
    public void onBindViewHolder(TaskViewHolder taskViewHolder, int position){
       ...
       // taskViewHolder.mCheckBoxComplete.setChecked(setStateCheckBox(currentTask.getIsFinished()));
    }
    ...
    public class TaskViewHolder extends RecyclerView.ViewHolder{
        ...
        //private final CheckBox mCheckBoxComplete;
        private TaskViewHolder(View itemView){
            ...
            //mCheckBoxComplete = itemView.findViewById(R.id.complete_checkbox);
